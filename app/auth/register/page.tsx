...
export default function RegisterPage() {
  return (
    <main className="bg-gray-50 text-gray-900 font-sans min-h-screen flex flex-col">
      ...
      {/* Formulário */}
      <section className="flex flex-col items-center justify-center flex-1 px-4 pt-10">
        <div className="bg-white p-8 rounded-2xl shadow-md w-full max-w-md">
          ...
          <form className="space-y-4">
            <div>
              <label className="block text-gray-700 mb-1">Nome da Loja</label>
              <input
                type="text"
          ...
          <p className="text-sm text-center mt-4">
            Já tem uma conta?{" "}
            <Link href="/auth/login" className="text-[#007373] font-medium hover:underline">
              Entrar
            </Link>
          </p>
        </div>
